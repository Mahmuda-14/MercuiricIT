                    ...
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="sm:col-span-2 sm:col-start-1">
                                ...
                                <div className="mt-2">
                                    <input type="text" name="company" id="city" defaultValue={company} autocomplete="address-level2" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input type="number" name="age" id="region" defaultValue={age} autocomplete="address-level1" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                </div>
                            </div>
                            {/*  */}
                            ...
                            <div className="sm:col-span-2">
                                ...
                                <div className="mt-2">
                                    <input type="tel" name="phone" id="postal-code" defaultValue={phone} autocomplete="postal-code" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
